      ...
      <React.Fragment>
        {
          this.state.enter ? (
            <div className="deshboard_container">
              <div className="welcome_pms">Enter Pensioner Details</div>
              <div className="login_input">
                <div className="username_wrap">
                  <label className="label_user pb-2">AADHAR NUMBER</label>
                  <input
                    type="text"
                ...
                <span className="field pt-2">Match the Aadhar Format</span>
                <div className="username_wrap">
                  <label className="label_user">PENSION TYPE</label>
                ...
                <span className="field">Field is required</span>
              </div>
            ...
            <div className="deshboard_container">
              ...
              <div className="pention_detail_wrap row ">
                <div className="pention_detail_right col-6">
                  <h3 className="">Pentioner Details</h3>
