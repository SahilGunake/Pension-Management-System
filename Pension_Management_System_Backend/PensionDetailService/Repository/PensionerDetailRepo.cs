...
namespace PensionDetailService.Repository
{
    ...
    {
        private readonly ILogger<PensionerDetailRepo> _logger;
        private readonly IConfiguration _configuration;

        public PensionerDetailRepo(ILogger<PensionerDetailRepo> logger, IConfiguration configuration)
        {
            _logger = logger;
        ...
        private PensionerDetail GetPensionerDetail(string aadhaarNumber)
        {
            ...
            using (SqlConnection connection = new SqlConnection(_configuration["ConnectionString"]))
            {
                ...
                {
                    connection.Open();
                    //string sqlQuery = "select * from PensionerDetail where Aadhaar= @Aadhaar;";
